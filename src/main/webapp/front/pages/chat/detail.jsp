							...
							<div class="row">
								...
								<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">
									<div class="product-content">
										...
										<div class="price">
											<span>管理员id：{{detail.adminid}}</span>
										</div>
										<div class="price">
											<span>提问：{{detail.ask}}</span>
										</div>
										<div class="price">
											<span>回复：{{detail.reply}}</span>
										</div>
										<div class="price">
											<span>是否回复：{{detail.isreply}}</span>
										</div>
