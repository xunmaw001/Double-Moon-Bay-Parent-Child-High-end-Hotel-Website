									...
									<div class="single-post-comments">
										<div class="comments-area">
											<div class="comments-heading">
												<h3 v-if="detail.childs">{{detail.childs.length}} 条回复</h3>
											</div>
											<div class="comments-list" v-if="detail.childs">
												<ul>
										...
										<div class="comment-respond">
											<h3 class="comment-reply-title">回复主贴</h3>
