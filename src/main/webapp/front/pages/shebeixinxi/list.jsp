	...
	<body>
						...
						<div :class="group?'col-md-9 col-sm-12 col-xs-12':'col-md-12 col-sm-12 col-xs-12'" >
							...
							<div style="display: flex;justify-content: flex-end;">
								<div class="input-group col-lg-3 col-md-12 col-sm-12" style="margin-left: 20px;margin-bottom: 20px">
									<input v-model="shebeimingcheng" type="text" class="form-control" placeholder="请输入设备名称">
									<span class="input-group-addon" style="background-color: #FE4847;color: #fff;cursor: pointor" @click="searchshebeimingchengTap"><i class="fa fa-search"></i></span>
								</div>
								<div class="input-group col-lg-3 col-md-12 col-sm-12" style="margin-left: 20px;margin-bottom: 20px">
									<input v-model="shebeizhuangtai" type="text" class="form-control" placeholder="请输入设备状态">
									<span class="input-group-addon" style="background-color: #FE4847;color: #fff;cursor: pointor" @click="searchshebeizhuangtaiTap"><i class="fa fa-search"></i></span>
								</div>
							</div>
		...
		<script type="text/javascript">
			...
			var app = new Vue({
				...
				methods: {
					searchshebeimingchengTap(){
						this.page.page = 1
						this.searchname = "shebeimingcheng"
						this.searchval = this.shebeimingcheng
						this.getList(this.searchname, this.searchval)
					},
					searchshebeizhuangtaiTap(){
						this.page.page = 1
						this.searchname = "shebeizhuangtai"
						this.searchval = this.shebeizhuangtai
						this.getList(this.searchname, this.searchval)
					},
					onPageTap(url) {
					...
					getList(searchname, searchval) {
						return new Promise((resolve) => {
							goodsList('shebeixinxi',this.page.page, this.page.limit, searchname, searchval, (res) => {
								if (res.code == 0) {
									this.$nextTick(() => {
