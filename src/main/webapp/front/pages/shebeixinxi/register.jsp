					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="login-content login-margin">
								<h2 class="login-title">设备信息注册</h2>
								<p>Create your own Unicase account.</p>
								<div class="form">
									<label>设备编号</label>
									<input type="text" v-model="shebeibianhao"/>
									<label>设备名称</label>
									<input type="text" v-model="shebeimingcheng"/>
									<label>使用区域</label>
									<input type="text" v-model="shiyongquyu"/>
				...
				methods: {
					userRegister(){
						var data = {
							...
							"shiyongquyu": this.shiyongquyu,
						}
						register('shebeixinxi', data, function(res){
							if(res.code==0){
								alert('注册成功')
