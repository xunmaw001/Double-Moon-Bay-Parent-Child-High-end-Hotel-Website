							...
							<div class="row">
								...
								<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">
									<div class="product-content">
										<div class="price">
											<span>设备编号：{{detail.shebeibianhao}}</span>
										</div>
										<div class="price">
											<span>设备名称：{{detail.shebeimingcheng}}</span>
										</div>
										<div class="price">
											<span>使用区域：{{detail.shiyongquyu}}</span>
										</div>
										<div class="price">
											<span>设备状态：{{detail.shebeizhuangtai}}</span>
										</div>
										<div class="price">
											<span>设备详情：{{detail.shebeixiangqing}}</span>
										</div>
