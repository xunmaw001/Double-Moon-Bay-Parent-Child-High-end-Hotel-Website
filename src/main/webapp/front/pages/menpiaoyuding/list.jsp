						...
						<div :class="group?'col-md-9 col-sm-12 col-xs-12':'col-md-12 col-sm-12 col-xs-12'" >
							...
							<div style="display: flex;justify-content: flex-end;">
								<div class="input-group col-lg-3 col-md-12 col-sm-12" style="margin-left: 20px;margin-bottom: 20px">
									<input v-model="yonghuming" type="text" class="form-control" placeholder="请输入用户名">
									<span class="input-group-addon" style="background-color: #FE4847;color: #fff;cursor: pointor" @click="searchyonghumingTap"><i class="fa fa-search"></i></span>
								</div>
								<div class="input-group col-lg-3 col-md-12 col-sm-12" style="margin-left: 20px;margin-bottom: 20px">
									<input v-model="huodongleixing" type="text" class="form-control" placeholder="请输入活动类型">
									<span class="input-group-addon" style="background-color: #FE4847;color: #fff;cursor: pointor" @click="searchhuodongleixingTap"><i class="fa fa-search"></i></span>
								</div>
							</div>
		...
		<script type="text/javascript">
			...
			var app = new Vue({
				...
				methods: {
					searchyonghumingTap(){
						this.page.page = 1
						this.searchname = "yonghuming"
						this.searchval = this.yonghuming
						this.getList(this.searchname, this.searchval)
					},
					searchhuodongleixingTap(){
						this.page.page = 1
						this.searchname = "huodongleixing"
						this.searchval = this.huodongleixing
						this.getList(this.searchname, this.searchval)
					},
					onPageTap(url) {
					...
					getList(searchname, searchval) {
						return new Promise((resolve) => {
							goodsList('menpiaoyuding',this.page.page, this.page.limit, searchname, searchval, (res) => {
								if (res.code == 0) {
									this.$nextTick(() => {
