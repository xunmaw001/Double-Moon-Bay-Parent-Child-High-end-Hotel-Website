							...
							<div class="row">
								...
								<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">
									<div class="product-content">
										<div class="price">
											<span>留言人id：{{detail.userid}}</span>
										</div>
										<div class="price">
											<span>留言人用户名：{{detail.username}}</span>
										</div>
										<div class="price">
											<span>留言内容：{{detail.content}}</span>
										</div>
										<div class="price">
											<span>回复内容：{{detail.reply}}</span>
										</div>
