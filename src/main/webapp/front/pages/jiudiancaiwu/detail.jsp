							...
							<div class="row">
								...
								<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">
									<div class="product-content">
										<div class="price">
											<span>财务标题：{{detail.caiwubiaoti}}</span>
										</div>
										<div class="price">
											<span>年份：{{detail.nianfen}}</span>
										</div>
										<div class="price">
											<span>月份：{{detail.yuefen}}</span>
										</div>
										<div class="price">
											<span>客房收入：{{detail.kefangshouru}}</span>
										</div>
										<div class="price">
											<span>其他收入：{{detail.qitashouru}}</span>
										</div>
										<div class="price">
											<span>收入金额：{{detail.shourujine}}</span>
										</div>
										<div class="price">
											<span>支出金额：{{detail.zhichujine}}</span>
										</div>
										<div class="price">
											<span>结余金额：{{detail.jieyujine}}</span>
										</div>
										<div class="price">
											<span>登记日期：{{detail.dengjiriqi}}</span>
										</div>
				...
				async created() {
					...
					if(typeof frontmenus == "object"){
						frontmenus.forEach(item => {
							if(item.menutable == "jiudiancaiwu"){
