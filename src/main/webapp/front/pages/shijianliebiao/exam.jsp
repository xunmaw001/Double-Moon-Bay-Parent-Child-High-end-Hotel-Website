...
<html class="no-js" lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../../assets/css/elementui.css" />
		<style type="text/css">
			.container {
		...
		<script type="text/javascript">
			var app = new Vue({
				...
				mounted() {
					let _this = this;
					let id = getParam("id");
					let table = localStorage.getItem("sessionTable");
					http(`${table}/session`, 'get', {}, function(data) {
					...
					http(`examquestion/page`, 'get', params, function(data) {
					...
					http(`exampaper/info/${id}`, 'get', {}, function(data) {
				...
				methods: {
					...
					submitTap() {
						...
						httpJson(`examrecord/save`, 'post', record, function(res) {});
					},
					nextTap() {
