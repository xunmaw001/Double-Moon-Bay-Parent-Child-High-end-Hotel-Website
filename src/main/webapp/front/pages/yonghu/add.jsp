				...
				<div class="form-control form-content">
					...
					<div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
							  <input v-model="detail.dianziyouxiang" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入电子邮箱" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
		...
		<script type="text/javascript">
			var app = new Vue({
				...
				methods: {
					...
					if(!isEmail(this.detail.dianziyouxiang)){
						alert(`电子邮箱应输入邮件格式`);
						return
					}
