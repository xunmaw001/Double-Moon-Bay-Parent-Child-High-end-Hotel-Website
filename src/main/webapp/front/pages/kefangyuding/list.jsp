	...
	<body>
						...
						<div :class="group?'col-md-9 col-sm-12 col-xs-12':'col-md-12 col-sm-12 col-xs-12'" >
							...
							<div style="display: flex;justify-content: flex-end;">
								<div class="input-group col-lg-3 col-md-12 col-sm-12" style="margin-left: 20px;margin-bottom: 20px">
									<input v-model="kefangleixing" type="text" class="form-control" placeholder="请输入客房类型">
									<span class="input-group-addon" style="background-color: #FE4847;color: #fff;cursor: pointor" @click="searchkefangleixingTap"><i class="fa fa-search"></i></span>
								</div>
								<div class="input-group col-lg-3 col-md-12 col-sm-12" style="margin-left: 20px;margin-bottom: 20px">
		...
		<script type="text/javascript">
			...
			var app = new Vue({
				...
				methods: {
					searchkefangleixingTap(){
						this.page.page = 1
						this.searchname = "kefangleixing"
						this.searchval = this.kefangleixing
					...
					getList(searchname, searchval) {
						return new Promise((resolve) => {
							goodsList('kefangyuding',this.page.page, this.page.limit, searchname, searchval, (res) => {
								if (res.code == 0) {
									this.$nextTick(() => {
