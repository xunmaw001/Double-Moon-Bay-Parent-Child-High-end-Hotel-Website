							...
							<div class="row">
								...
								<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">
									<div class="product-content">
										...
										<div class="price">
											<span>预定数量：{{detail.yudingshuliang}}</span>
										</div>
										<div class="price">
											<span>入住天数：{{detail.ruzhutianshu}}</span>
										</div>
										<div class="price">
											<span>入住日期：{{detail.ruzhuriqi}}</span>
										</div>
										<div class="price">
										...
										<div class="price">
											<span>联系电话：{{detail.lianxidianhua}}</span>
										</div>
										<div class="price">
											<span>预定时间：{{detail.yudingshijian}}</span>
										</div>
										<div class="price">
				...
				async created() {
					...
					if(typeof frontmenus == "object"){
						frontmenus.forEach(item => {
							if(item.menutable == "kefangyuding"){
