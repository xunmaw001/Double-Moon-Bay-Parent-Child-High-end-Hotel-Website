											...
											<div class="single-product-box col-md-3 col-sm-4" v-for="(item, i) in list" :key="i" @click="onPageTap(`./detail.jsp?id=${item.id}`)">
												<div class="single-product">
													<div class="product-img" v-if="item.huodongfengmian">
														<img :style="{height:group?'200px':'300px'}" :src="item.huodongfengmian.split(',')[0]" alt="" />
													</div>
		...
		<script type="text/javascript">
			...
			var app = new Vue({
				...
				methods: {
					...
					getList(searchname, searchval) {
						return new Promise((resolve) => {
							goodsList('qinzihuodong',this.page.page, this.page.limit, searchname, searchval, (res) => {
								if (res.code == 0) {
									this.$nextTick(() => {
				...
				async created() {
					...
					var searchname = 'huodongmingcheng'
