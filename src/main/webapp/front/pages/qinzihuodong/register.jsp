    ...
    <body>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="login-content login-margin">
								<h2 class="login-title">亲子活动注册</h2>
								...
								<div class="form">
									...
									<label>活动地点</label>
									<input type="text" v-model="huodongdidian"/>
									<label>赞</label>
		...
		<script type="text/javascript">
			var app = new Vue({
				...
				methods: {
					userRegister(){
					if(!isIntNumer(this.menpiaojiage)){
						alert(`门票价格应输入整数`);
						return
					}
					...
					if(!isIntNumer(this.crazilynum)){
						...
						var data = {
							...
							"huodongdidian": this.huodongdidian,
							"thumbsupnum": this.thumbsupnum,
							"crazilynum": this.crazilynum,
						}
						register('qinzihuodong', data, function(res){
							if(res.code==0){
								alert('注册成功')
