						...
						<div :class="group?'col-md-9 col-sm-12 col-xs-12':'col-md-12 col-sm-12 col-xs-12'" >
							...
							<div style="display: flex;justify-content: flex-end;">
								<div class="input-group col-lg-3 col-md-12 col-sm-12" style="margin-left: 20px;margin-bottom: 20px">
									<input v-model="name" type="text" class="form-control" placeholder="请输入收藏名称">
									<span class="input-group-addon" style="background-color: #FE4847;color: #fff;cursor: pointor" @click="searchnameTap"><i class="fa fa-search"></i></span>
								</div>
							</div>
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="home">
										<div class="row" style="display: flex;flex-wrap: wrap;">
											...
											<div class="single-product-box col-md-3 col-sm-4" v-for="(item, i) in list" :key="i" @click="onPageTap(`../${item.tablename}/detail.jsp?id=${item.refid}`)">
												<div class="single-product">
													<div class="product-img" v-if="item.picture">
														<img :style="{height:group?'200px':'300px'}" :src="item.picture.split(',')[0]" alt="" />
													</div>
													<h3>{{item.name}}</h3>
													</div>
												</div>
