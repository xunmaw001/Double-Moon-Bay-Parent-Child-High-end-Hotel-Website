					...
					<div>
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
							  <input v-model="detail.refid" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入收藏id" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">表名</label>
							<div class="layui-input-block">
							  <input v-model="detail.tablename" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入表名" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">收藏名称</label>
							<div class="layui-input-block">
							  <input v-model="detail.name" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入收藏名称" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
			...
			var app = new Vue({
				...
				methods: {
					...
					onConfirmTap(){
						...
						addFun("storeup", this.detail, (res) => {
							if(res&&res.code==0){
								alert("提交成功")
								window.history.go(-1);
							}
