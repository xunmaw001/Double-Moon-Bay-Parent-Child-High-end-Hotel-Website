										...
										<thead>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="biaotiTh" class="sorting" onclick="sort('biaoti')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">标题</th>
	...
	<script >
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("fangxingjieshao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("fangxingjieshao" + colName,"GET",{
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"fangxingjieshao");
