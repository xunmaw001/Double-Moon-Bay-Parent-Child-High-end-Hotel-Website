									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					<div class="form-group">
																								...
																								<input id="huodongmingcheng" v-model="ruleForm.huodongmingcheng" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>活动类型</label>
																								
																								<input id="huodongleixing" v-model="ruleForm.huodongleixing" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="menpiaojiage" v-model="ruleForm.menpiaojiage" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>活动地点</label>
																								
																								<input id="huodongdidian" v-model="ruleForm.huodongdidian" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>开始时间</label>
																								
																								<input id="kaishishijian" v-model="ruleForm.kaishishijian" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>结束时间</label>
																								
																								<input id="jieshushijian" v-model="ruleForm.jieshushijian" readonly>
																							</div>
												...
												<input type="hidden" id="huodongxiangqing-input">
											</div>
																																																																																																																								</form>
										</div>
									</div>
	...
	<script>
		...
		function setContent(){
					...
					huodongxiangqingUeditor.ready(function() {
						...
						huodongxiangqingUeditor.setDisabled('fullscreen');
					});
				}
																				}  
