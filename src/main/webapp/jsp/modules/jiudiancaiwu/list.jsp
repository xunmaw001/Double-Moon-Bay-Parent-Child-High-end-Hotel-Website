									...
									<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
										...
										<div class="col-sm-12">
											<div id="add-row_filter" class="dataTables_filter">
																																																																															<label>年份 <input type="text" id="nianfenSearch" class="form-control form-control-sm" placeholder="" aria-controls="add-row"></label>
																																																																																	<label>月份</label>
																<select name="yuefen" id="yuefenSelect">
																																	<option value=" "> </option>
										...
										<thead>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="caiwubiaotiTh" class="sorting" onclick="sort('caiwubiaoti')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">财务标题</th>
																																																			<th id="nianfenTh" class="sorting" onclick="sort('nianfen')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">年份</th>
																																																			<th id="yuefenTh" class="sorting" onclick="sort('yuefen')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">月份</th>
																																																			<th id="kefangshouruTh" class="sorting" onclick="sort('kefangshouru')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">客房收入</th>
																																																			<th id="qitashouruTh" class="sorting" onclick="sort('qitashouru')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">其他收入</th>
																																																			<th id="shourujineTh" class="sorting" onclick="sort('shourujine')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">收入金额</th>
																																																			<th id="zhichujineTh" class="sorting" onclick="sort('zhichujine')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">支出金额</th>
																																																			<th id="jieyujineTh" class="sorting" onclick="sort('jieyujine')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">结余金额</th>
																																																			<th id="dengjiriqiTh" class="sorting" onclick="sort('dengjiriqi')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">登记日期</th>
	...
	<script >
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
							...
							var caiwubiaotiCell  = document.createElement('td');

												 caiwubiaotiCell.innerHTML = item.caiwubiaoti;

                
													row.appendChild(caiwubiaotiCell);
            				...
            				var kefangshouruCell  = document.createElement('td');

												 kefangshouruCell.innerHTML = item.kefangshouru;

                
													row.appendChild(kefangshouruCell);
				
            				var qitashouruCell  = document.createElement('td');

												 qitashouruCell.innerHTML = item.qitashouru;

                
													row.appendChild(qitashouruCell);
				
            				var shourujineCell  = document.createElement('td');

												 shourujineCell.innerHTML = item.shourujine;

                
													row.appendChild(shourujineCell);
				
            				var zhichujineCell  = document.createElement('td');

												 zhichujineCell.innerHTML = item.zhichujine;

                
													row.appendChild(zhichujineCell);
				
            				var jieyujineCell  = document.createElement('td');

												 jieyujineCell.innerHTML = item.jieyujine;

                
													row.appendChild(jieyujineCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jiudiancaiwu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"jiudiancaiwu");
