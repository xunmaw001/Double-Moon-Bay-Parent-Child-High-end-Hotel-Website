									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					<div class="form-group">
																								...
																								<input id="caiwubiaoti" v-model="ruleForm.caiwubiaoti" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>年份</label>
																								
																								<input id="nianfen" v-model="ruleForm.nianfen" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>月份</label>
																								
																								<input id="yuefen" v-model="ruleForm.yuefen" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>客房收入</label>
																								
																								<input id="kefangshouru" v-model="ruleForm.kefangshouru" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>其他收入</label>
																								
																								<input id="qitashouru" v-model="ruleForm.qitashouru" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>收入金额</label>
																								
																								<input id="shourujine" v-model="ruleForm.shourujine" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>支出金额</label>
																								
																								<input id="zhichujine" v-model="ruleForm.zhichujine" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>结余金额</label>
																								
																								<input id="jieyujine" v-model="ruleForm.jieyujine" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>登记日期</label>
																								
																								<input id="dengjiriqi" v-model="ruleForm.dengjiriqi" readonly>
																							</div>
