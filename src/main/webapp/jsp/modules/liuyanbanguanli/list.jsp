...
<body>
				...
				<div class="page-inner" style="padding-left: 10px; padding-right: 10px;">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item"><a href="#">留言板管理</a></li>
						</ul>
					</div>
												...
												<div class="col-sm-12">
													<div id="add-row_filter" class="dataTables_filter">
														<!--  <label>留言人用户名 <input type="text"
															id="usernameSearch" class="form-control form-control-sm"
															placeholder="" aria-controls="add-row"></label>-->
													...
													<table id="add-row"
														...
														<thead>
															...
															<tr role="row">
																...
																<th id="usernameTh" class="sorting"
																	onclick="sort('username')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">
																	留言人用户名</th>

																<th tabindex="0" aria-controls="add-row" rowspan="1"
																	colspan="1" style="min-width: 100px;">留言内容</th>

																<th tabindex="0" aria-controls="add-row" rowspan="1"
																	colspan="1" style="min-width: 100px;">回复内容</th>
	...
	<script>
		...
		function setDataRow(item) {
			...
			editBtn.setAttribute("class", "btn btn-warning btn-xs 回复");
