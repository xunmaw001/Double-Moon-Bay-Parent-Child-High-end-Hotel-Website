...
<body>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">酒店周边评论表</h4>
										...
										<thead>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="refidTh" class="sorting" onclick="sort('refid')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">关联表id</th>
																																																			<th id="contentTh" class="sorting" onclick="sort('content')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">评论内容</th>
																																																			<th id="useridTh" class="sorting" onclick="sort('userid')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">用户id</th>
	...
	<script >
		...
		var tableName = "discussjiudianzhoubian";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
        ...
        function getDataList() {
			http("discussjiudianzhoubian/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("discussjiudianzhoubian/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("discussjiudianzhoubian" + colName,"GET",{
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"discussjiudianzhoubian");
