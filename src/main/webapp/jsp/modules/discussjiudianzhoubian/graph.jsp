...
<body>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">酒店周边评论表统计</h4>
	...
	<script >
		...
		$.ajax({ 
			type: "GET",
			url: baseUrl+"value/discussjiudianzhoubian/"+xColumnName+'/'+yColumnName,
			data:{ },
		...
		function group(colName){
			$.ajax({ 
                type: "GET",
                url: baseUrl+"group/discussjiudianzhoubian/"+colName,
             	data:{	tableName: "discussjiudianzhoubian",
                    	columnName: colName
					 },
                beforeSend: function(xhr) {
                    xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
