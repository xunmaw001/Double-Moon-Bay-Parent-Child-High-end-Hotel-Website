...
<body>
									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					<div class="form-group">
																								...
																								<input id="shebeibianhao" v-model="ruleForm.shebeibianhao" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>设备名称</label>
																								
																								<input id="shebeimingcheng" v-model="ruleForm.shebeimingcheng" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="shiyongquyu" v-model="ruleForm.shiyongquyu" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>设备状态</label>
																								
																								<input id="shebeizhuangtai" v-model="ruleForm.shebeizhuangtai" readonly>
																							</div>
																					...
																					<div class="form-group">
																																																																																																																																																																																																																													...
																																																																																																																																																																																																																													<div class="form-group">
												<label>设备详情</label>
												<script id="shebeixiangqingEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var shebeixiangqingUe = UE.getEditor('shebeixiangqingEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" id="shebeixiangqing-input">
											</div>
																																								</form>
										</div>
									</div>
	...
	<script>
		...
		// 填充富文本框
		function setContent(){
																																								if(ruleForm.shebeixiangqing != null && ruleForm.shebeixiangqing != 'null' && ruleForm.shebeixiangqing != ''){
					var shebeixiangqingMes = '' + ruleForm.shebeixiangqing;
					var shebeixiangqingUeditor = UE.getEditor('shebeixiangqingEditor');
					shebeixiangqingUeditor.ready(function() {
						shebeixiangqingUeditor.setContent(shebeixiangqingMes);
						shebeixiangqingUeditor.setDisabled('fullscreen');
					});
				}
								}  
