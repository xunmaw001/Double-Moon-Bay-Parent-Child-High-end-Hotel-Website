				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/menpiaoyuding/list.jsp">门票预定</a>
							</li>
						</ul>
					</div>
					<div class="row">
									...
									<div class="row">
										...
										<form id="addOrUpdateForm" method="post">
											...
											<div class="form-group">
												...
												<input id="huodongleixing" name="huodongleixing" class="form-control" placeholder="活动类型">
												</div>	
											<div class="form-group">
												<label>门票价格</label>
											...
											<div class="form-group">
												...
												<input id="canjiarenshu" name="canjiarenshu" class="form-control" onchange="calculation()">
												</div>	
											<div class="form-group">
												<label>实付金额</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "menpiaoyuding/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("menpiaoyuding/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				...
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("menpiaoyuding/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						setSelectOption();
						// 设置图片src
			...
			var flag = 0;
								...
								if(x == 0 && flag < 2){
									...
									flag++;
																																														...
																																														if($("#canjiarenshu").val() != null && $("#canjiarenshu").val() != ""){
								if(x == 0 && flag < 2){
									x = (x+1) * parseFloat($("#canjiarenshu").val());
									flag++;
								}else{
									x = x * parseFloat($("#canjiarenshu").val());
									flag++;
								}
							}
																																																												if(flag < 2){
		...
		function calculationSE(colName){
			//单列求和接口
			http("menpiaoyuding"+colName,"GET",{
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.huodongleixing != null && res.data.huodongleixing != ''){
															...
															$("#huodongleixing").val(res.data.huodongleixing);
													}
												...
												if(res.data != null && res.data != '' && res.data.canjiarenshu != null && res.data.canjiarenshu != ''){

															$("#canjiarenshu").val(res.data.canjiarenshu);
													}
