	...
	<script >
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("kefangleibie/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"kefangleibie");
