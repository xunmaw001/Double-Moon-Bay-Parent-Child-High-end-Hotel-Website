									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					<div class="form-group">
																								...
																								<input id="kefangbianhao" v-model="ruleForm.kefangbianhao" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="kefangmianji" v-model="ruleForm.kefangmianji" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>客房楼层</label>
																								
																								<input id="kefanglouceng" v-model="ruleForm.kefanglouceng" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>免费宽带</label>
																								
																								<input id="mianfeikuandai" v-model="ruleForm.mianfeikuandai" readonly>
																							</div>
												...
												<input type="hidden" id="kefangjieshao-input">
											</div>
																																																																																																																								</form>
										</div>
									</div>
	...
	<script>
		...
		function setContent(){
					...
					kefangjieshaoUeditor.ready(function() {
						...
						kefangjieshaoUeditor.setDisabled('fullscreen');
					});
				}
																				}  
