...
<body>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">房型介绍评论表统计</h4>
	...
	<script >
		...
		$.ajax({ 
			type: "GET",
			url: baseUrl+"value/discussfangxingjieshao/"+xColumnName+'/'+yColumnName,
			data:{ },
		...
		function group(colName){
			$.ajax({ 
                type: "GET",
                url: baseUrl+"group/discussfangxingjieshao/"+colName,
             	data:{	tableName: "discussfangxingjieshao",
                    	columnName: colName
					 },
                beforeSend: function(xhr) {
                    xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
