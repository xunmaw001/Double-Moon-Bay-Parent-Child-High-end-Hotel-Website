											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="yonghumingTh" class="sorting" onclick="sort('yonghuming')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">用户名</th>
																																																			<th id="mimaTh" class="sorting" onclick="sort('mima')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">密码</th>
																																																			<th id="xingmingTh" class="sorting" onclick="sort('xingming')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">姓名</th>
																																																			<th id="xingbieTh" class="sorting" onclick="sort('xingbie')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">性别</th>
																																																			...
																																																			<th id="dianziyouxiangTh" class="sorting" onclick="sort('dianziyouxiang')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">电子邮箱</th>
																																																			<th id="shenfenzhenghaoTh" class="sorting" onclick="sort('shenfenzhenghao')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">身份证号</th>
																																																			
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">个人照片</th>
	...
	<script >
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
				  ...
				  gerenzhaopianImg.setAttribute('height','100px');
				  gerenzhaopianImg.setAttribute('width','100px');
