...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/normalize.css">
...
<div class="login">
	...
	<form method="post" id="registerForm">
														<input type="text" name="yonghuming" placeholder="用户名" />
				
																<input type="text" name="mima" placeholder="密码" />
				
																<input type="text" name="xingming" placeholder="姓名" />
				
																							<input type="text" name="lianxidianhua" placeholder="联系电话" />
				
																<input type="text" name="dianziyouxiang" placeholder="电子邮箱" />
				
																<input type="text" name="shenfenzhenghao" placeholder="身份证号" />
				
																		<button type="button" id="submitBtn" class="btn btn-primary btn-block btn-large">注册</button>
	</form>
</div>
