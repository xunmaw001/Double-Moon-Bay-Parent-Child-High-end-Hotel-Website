									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group">
																								...
																								<input id="xingbie" v-model="ruleForm.xingbie" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="dianziyouxiang" v-model="ruleForm.dianziyouxiang" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>身份证号</label>
																								
																								<input id="shenfenzhenghao" v-model="ruleForm.shenfenzhenghao" readonly>
																							</div>
