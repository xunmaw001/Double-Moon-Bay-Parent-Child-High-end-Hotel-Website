	...
	<script >
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zengjiafangyuan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("zengjiafangyuan" + colName,"GET",{
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"zengjiafangyuan");
