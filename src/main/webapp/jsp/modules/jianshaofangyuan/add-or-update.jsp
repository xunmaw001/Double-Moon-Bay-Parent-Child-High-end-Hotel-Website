				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/jianshaofangyuan/list.jsp">减少房源</a>
							</li>
						</ul>
					</div>
					<div class="row">
									...
									<div class="row">
										...
										<form id="addOrUpdateForm" method="post">
											...
											<div class="form-group">
												...
												<input id="kefangbianhao" name="kefangbianhao" class="form-control" placeholder="客房编号">
												</div>	
											<div class="form-group">
												<label>客房类型</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jianshaofangyuan/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("jianshaofangyuan/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				...
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jianshaofangyuan/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						setSelectOption();
						// 设置图片src
       ...
       //跨表
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.shengyufangjian != null && res.data.shengyufangjian != ''){
															...
															shengyufangjianKucun = res.data.shengyufangjian;
		...
		function crossTableUpdate(){
			...
			if(flag){
				httpJson(crossTableName + "/update","POST",{
					id: crossTableId,
																																								shengyufangjian: crossRuleForm.shengyufangjian - $('#shengyufangjian').val(),	
																										},(res)=>{
					if(res.code == 0){
						console.log('跨表更新成功');
						return true;
		...
		function crossTableUpdateValidation(){
			//防止减法导致库存负值
																										if(shengyufangjianKucun < $('#shengyufangjian').val()){
						alert('剩余房间不能大于'+shengyufangjianKucun+'！请重新输入');
						return false;
					}
																	return true;
		}
